...
os_iso_path             = "[ESXi_ISO] /iso/linux/ubuntu/ubuntu-20.04.5-live-server-amd64.iso"
vmtools_iso_path        = "[ESXi_ISO] /tools_repo/vmtools/linux.iso"
boot_wait               = "45s"
boot_command            = [
                            ...
                            " url=http://ubuntudev.lab.fullstackgeek.net:80/boot_files/ubuntu2004/preseed.cfg",
                            " -- <wait>",
                            "<enter><wait>"
                        ]
config_files            = []
